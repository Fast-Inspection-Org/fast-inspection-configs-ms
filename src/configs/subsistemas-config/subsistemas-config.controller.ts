...
export class SubsistemasConfigController {
    ...
    public async createSubsistemaConfig(subistemaConfigDTO: SubsistemaConfigDTO) {
        try {
            await this.subsistemasConfigService.createSubSistemaConfig(subistemaConfigDTO)
            return { success: true }
        } catch (error) {
            throw new RpcException({
                message: error.message,
    ...
    public async updateSubsistemaConfig(payload: {
        ...
        try {
            await this.subsistemasConfigService.updateSubsistemaConfig(payload.idSubsistemaConfig, payload.idSistemaConfig,
    ...
    public async deleteSubsistemaConfig(idSubsistemaConfig: number) {
        try {
            await this.subsistemasConfigService.deleteSubsistemaConfig(idSubsistemaConfig)
            return { success: true }
        } catch (error) {
            throw new RpcException({
                message: error.message,
