...
export class IndicadorSinIntervaloService {
    ...
    public async createIndicadorSinIntervalo(indicadorSinIntervaloDTO: IndicadorSinIntervaloDTO, entityManager?: EntityManager) {
    ...
    public async createIndicadorSinIntervaloWithEntity(indicadorSinIntervaloDTO: IndicadorSinIntervaloDTO, entityManager: EntityManager) {
        const indicadorSinIntervalo: IndicadorSinIntervalo = new IndicadorSinIntervalo(indicadorSinIntervaloDTO.nombre, indicadorSinIntervaloDTO.valor,
            indicadorSinIntervaloDTO.indiceCalculableSinIntervalo instanceof IndiceCalculableSinIntervalo ? indicadorSinIntervaloDTO.indiceCalculableSinIntervalo : undefined) // se crea un objeto de la entidad con los datos propocionados
