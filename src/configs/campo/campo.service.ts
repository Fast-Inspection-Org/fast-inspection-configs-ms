...
export class CampoService {
    ...
    public async getAllCampos(nombre: String, importancia: number, idHerramienta: number) {
    ...
    public async createCampo(campoDTO: CampoDTO, entityManager?: EntityManager) {
        ...
        if (!(await this.getCampo(undefined, campoDTO.nombre, undefined, campoDTO.herramientaAnalisisCriticidad.id))) {
            ...
            throw new HttpException("Ya existe un campo con ese nombre", HttpStatus.BAD_REQUEST)
    }
    ...
    private async createCampoWithEntityManager(campoDTO: CampoDTO, entityManager?: EntityManager) {
        const campo: Campo = new Campo(campoDTO.nombre, campoDTO.nivelImportancia,
            campoDTO.configVersion, campoDTO.herramientaAnalisisCriticidad instanceof HerramientaAnalisisCriticidad ? campoDTO.herramientaAnalisisCriticidad : new HerramientaAnalisisCriticidad(campoDTO.herramientaAnalisisCriticidad.id)) // se crea el campo
    ...
    public async getCampo(idCampo: number, nombre?: String, configVersion?: number, idHerramientaAnalisisCriticidad?: number) {
    ...
    public async updateCampo(idCampo: number, updateCampoDTO: UpdateCampoDTO) {
        ...
        const campoExistente: Campo = await this.getCampo(undefined, updateCampoDTO.nombre, undefined, campoUpdate.herramientaAnalisisCriticidadId)
